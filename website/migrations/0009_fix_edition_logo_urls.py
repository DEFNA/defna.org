...
LOGO_URLS = {
    ...
    2017: "/static/images/spokane.png",
...
def fix_logo_urls(apps, schema_editor):
    ...
    for year, logo_url in LOGO_URLS.items():
        DjangoConEdition.objects.filter(year=year).update(logo_url=logo_url)


class Migration(migrations.Migration):
    dependencies = [
        ("website", "0008_backfill_edition_logo_urls"),
    ]

    operations = [
        migrations.RunPython(fix_logo_urls, reverse_code=migrations.RunPython.noop),
    ]
